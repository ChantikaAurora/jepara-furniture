<style>
/* Product Create/Edit Form - Dashboard Theme */
.form-wrapper {
...
<div class="form-wrapper">
    ...
    <div class="page-header">
        ...
        <p class="page-subtitle">
            Lengkapi informasi produk furniture yang akan ditambahkan ke katalog toko
        </p>
    </div>
    ...
    <form action="<?= base_url('admin/produk/store') ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="radio-group">
                            <div class="radio-option">
                                <input type="radio" name="tipe_produk" value="jadi" id="tipe_jadi" checked>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" 
                               name="dimensi" 
                               class="form-control" 
                               placeholder="Contoh: 120x80x90 cm">
                    </div>
                </div>
        ...
        <div class="form-section">
            ...
            <div class="form-group">
                <div class="radio-group">
                    <div class="radio-option">
                        <input type="radio" name="status" value="active" id="status_active" checked>
