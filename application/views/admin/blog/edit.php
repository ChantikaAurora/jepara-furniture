<style>
/* Blog Edit - Same as Create with current image display */
.create-wrapper {
...
<div class="create-wrapper">
    ...
    <div class="form-container">
        <form method="post" action="<?= base_url('admin/blog/update/' . $post->id) ?>" enctype="multipart/form-data">
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <input type="text" 
                           ...
                           value="<?= set_value('judul', $post->judul) ?>"
                           required>
                ...
                <div class="form-group">
                    ...
                    <select name="kategori_blog" class="form-control" required>
                        ...
                        <option value="<?= $cat ?>" <?= set_select('kategori_blog', $cat, ($post->kategori_blog == $cat)) ?>>
                            <?= $cat ?>
                        </option>
                        <?php endforeach; ?>
                    </select>
                ...
                <div class="form-group">
                    ...
                    <div class="current-image">
                        <img src="<?= base_url('uploads/blog/' . $post->gambar_utama) ?>" alt="Current Image">
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <textarea name="konten" 
                              ...
                              required><?= set_value('konten', $post->konten) ?></textarea>
                    <div class="form-text">Gunakan HTML tags untuk formatting</div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="excerpt" 
                              ...
                              rows="3"><?= set_value('excerpt', $post->excerpt) ?></textarea>
                ...
                <div class="form-group">
                    <div class="checkbox-wrapper">
                        <input type="checkbox" 
                               ...
                               name="is_published" 
                               value="1"
                               <?= set_checkbox('is_published', '1', ($post->is_published == 1)) ?>>
                        <label for="is_published">Publikasikan artikel</label>
                    </div>
                    <div class="form-text">
                        <?php if ($post->is_published): ?>
                        Artikel saat ini: <strong style="color: #10b981;">Published</strong>
                        <?php else: ?>
                        Artikel saat ini: <strong style="color: #6b7280;">Draft</strong>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
